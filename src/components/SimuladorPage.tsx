...
const SimuladorPage = ({
  ...
  <div>
    ...
    <section className="py-12 bg-card/50">
      <div className="container max-w-4xl">
        <h2 className="font-mono text-xl md:text-2xl text-foreground mb-8">{"// CARACTERÍSTICAS"}</h2>
    ...
    <section className="py-12">
      <div className="container max-w-4xl">
        <h2 className="font-mono text-xl md:text-2xl text-foreground mb-8">{"// MISIONES"}</h2>
        <div className="space-y-3">
          {missions.map((m, i) => (
            <div key={i} className="flex items-center gap-3 terminal-card p-4">
              <Terminal className="h-4 w-4 text-terminal-dim shrink-0" />
    ...
    <section className="py-12 bg-card/50">
      <div className="container max-w-4xl">
        <h2 className="font-mono text-xl md:text-2xl text-foreground mb-8">{"// AVISOS IMPORTANTES"}</h2>
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="flex items-start gap-3 p-4 rounded-sm border border-terminal-amber/30 bg-terminal-amber/5">
    ...
    <section className="py-16 md:py-24 text-center">
      <div className="container max-w-2xl">
        <h2 className="font-mono text-2xl md:text-3xl text-foreground terminal-glow mb-6">
          {`> INICIAR ${module.toUpperCase()}`}
        </h2>
        <p className="text-muted-foreground mb-8">
          Accede al simulador y empieza a practicar hoy mismo.
        </p>
        <Button asChild size="lg" className="font-mono text-base gap-2">
